...
CATEGORIES = [
    {"slug": "general-handyman-home-repairs", "name": "General Handyman & Home Repairs", "icon": "Hammer",
     ...
     "services_list": ["General Handyman Service", "General Home Repairs", "Property Repairs", "Minor Household Repairs", "Odd Jobs", "Small Repair Jobs", "Home Maintenance", "Regular Maintenance", "Preventative Maintenance", "Emergency Small Repairs", "Fixture Repairs", "Fittings Replacement", "Sealant Replacement", "Silicone Sealing", "Draught Proofing", "General Adjustments", "Snagging Jobs", "Wall Repairs", "Ceiling Repairs", "Small Hole Repairs", "Crack Filling", "Minor Damage Repairs", "Home Fixture Installation", "Home Fixture Replacement"]},
    {"slug": "door-to-door-mobile-car-service", "name": "Door-to-Door Mobile Car Service", "icon": "Wrench",
     ...
     "image": "https://images.pexels.com/photos/16509869/pexels-photo-16509869.jpeg",
     "services_list": ["Engine Oil Change", "Oil Filter Change", "Air Filter Change", "Fuel Filter Change", "Cabin Filter Change", "Pollen Filter Change", "Fluid Top-Up", "Coolant Top-Up", "Screen Wash Top-Up", "Basic Vehicle Inspection", "Basic Vehicle Maintenance", "Battery Check", "Battery Replacement", "Battery Terminal Cleaning", "Jump Start", "Tyre Pressure Check", "Tyre Inflation", "Wheel Visual Check", "Tyre Visual Check", "Spare Wheel Change", "Basic Tyre Assistance", "Bulb Replacement", "Headlight Bulb Replacement", "Brake Light Bulb Replacement", "Indicator Bulb Replacement", "Wiper Blade Replacement", "Fuse Replacement", "Number Plate Replacement", "Car Washing", "Exterior Car Cleaning", "Interior Car Cleaning", "Interior & Exterior Cleaning", "Car Detailing", "Interior Detailing", "Exterior Detailing", "Vacuum Cleaning", "Dashboard Cleaning", "Vehicle Pressure Washing", "Van Cleaning"]},
    ...
    {"slug": "electrical-services", "name": "Electrical Services", "icon": "Zap",
     ...
     "services_list": ["Minor Electrical Repairs", "Light Fitting Installation", "Light Fitting Replacement", "Light Fixture Installation", "Ceiling Light Replacement", "Wall Light Installation", "Bulb Replacement", "LED Light Replacement", "Switch Replacement", "Socket Faceplate Replacement", "Doorbell Installation", "Battery Doorbell Installation", "Smoke Alarm Installation", "Carbon Monoxide Alarm Installation", "Basic Electrical Fixture Replacement"]},
    ...
    {"slug": "carpentry-woodwork", "name": "Carpentry & Woodwork", "icon": "Hammer",
     ...
     "image": "https://images.pexels.com/photos/16509869/pexels-photo-16509869.jpeg",
     "services_list": ["Minor Carpentry", "Timber Repairs", "Wooden Trim Repairs", "Skirting Board Work", "Architrave Repairs", "Door Frame Repairs", "Wooden Shelf Installation", "Cabinet Repairs", "Cupboard Repairs", "Wooden Furniture Repairs", "Fence Timber Repairs", "Gate Timber Repairs", "Minor Woodwork Installation", "Minor Woodwork Repairs"]},
    ...
    {"slug": "garden-outdoor-services", "name": "Garden & Outdoor Services", "icon": "Leaf",
     ...
     "services_list": ["Garden Maintenance", "Grass Cutting", "Lawn Mowing", "Lawn Edging", "Hedge Trimming", "Shrub Trimming", "Weed Removal", "Garden Clearance", "Leaf Clearance", "Fence Repairs", "Fence Panel Replacement", "Gate Repairs", "Gate Installation", "Shed Repairs", "Shed Assembly", "Garden Furniture Assembly", "Outdoor Furniture Repairs", "Decking Repairs", "Minor Decking Installation", "Patio Maintenance", "Outdoor General Repairs", "Garden Furniture Repairs"]},
    {"slug": "pressure-power-washing", "name": "Pressure & Power Washing", "icon": "Droplets",
     ...
     "image": "https://images.pexels.com/photos/36990157/pexels-photo-36990157.png",
     "services_list": ["Driveway Pressure Washing", "Patio Pressure Washing", "Paving Pressure Washing", "Block Paving Cleaning", "Concrete Cleaning", "Path Cleaning", "Walkway Cleaning", "Garden Wall Cleaning", "Brick Cleaning", "Fence Cleaning", "Decking Cleaning", "Garden Furniture Cleaning", "Shed Exterior Cleaning", "Garage Door Cleaning", "Exterior Wall Cleaning", "Render Cleaning", "Stone Cleaning", "Steps Cleaning", "Entrance Cleaning", "Bin Area Cleaning", "Wheelie Bin Cleaning", "Balcony Cleaning", "Car Pressure Washing", "Van Pressure Washing", "Exterior Vehicle Cleaning"]},
